...
import { ServiceCoreStage } from "@/components/home/service-core-stage";

const TICKS = Array.from({ length: 60 }, (_, index) => index);

// The "IET Service Core" hero object (design system doc section 6). The SVG renders instantly for
// everyone; capable desktops upgrade to the 3D version once the page is idle. All readable text is
// HTML, never inside the SVG or the canvas.
