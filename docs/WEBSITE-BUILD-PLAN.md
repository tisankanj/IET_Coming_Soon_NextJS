...
| Images | AI art for mood and service detail, real photos for evidence. See `IMAGE-BRIEF.md`. Branded placeholders until files arrive. All 11 AI art images, the official TVS logo and the real photos arrived on 17 September 2026, so no slot shows a placeholder any more. |
